...
```
ggplot(data=obesitybystate, aes(x=LocationAbbr, y=mean, fill=factor(LocationAbbr))) + 
  geom_bar(position="dodge", stat="identity") +xlab("State") + ylab("Obesity Rate") + scale_fill_brewer(palette="BuGn", direction=-1) + guides(fill=guide_legend(title="State"))
